...
def push_to_pinecone(pinecone_apikey,pinecone_environment,pinecone_index_name,embeddings,docs):
    ...
    if pinecone_index_name not in pinecone.list_indexes().names():
        pinecone.create_index(
            ...
            dimension=384,  # Set the dimension according to your embeddings
            metric='euclidean',  # Set the metric according to your requirements
    ...
    # Upsert documents
    pinecone_index.upsert([(str(doc.metadata["id"]), embedding) for doc, embedding in zip(docs, embeddings)])
